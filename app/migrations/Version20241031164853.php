...
final class Version20241031164853 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE training_catalog (id INT AUTO_INCREMENT NOT NULL, sub_catalog_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, subscription_type INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_C612A249E0F7F531 (sub_catalog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql("UPDATE setting SET value = 'Для покупки жми на кнопку и следуй инструкциям бота⬇️' WHERE id=2");
    }
